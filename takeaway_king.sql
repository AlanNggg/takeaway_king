...
CREATE TABLE `business_hour` (
  `restaurant_id` int(11) NOT NULL,
  `monday` varchar(11) DEFAULT NULL COMMENT '00:00-00:00',
...
INSERT INTO `restaurant` (`id`, `name`, `category`, `tel`, `area`, `district`, `sub-district`, `address`, `rate`, `visitors`) VALUES
(1, 'abc restaurant', 'chinese', '12345678', 'New Territories', 'Sha Tin', 'Tai Wai', 'New Territories, Sha Tin, Tai Wai, Lung Hang Shopping Centre No.22 abc restaurant', NULL, 0);
...
--
-- 資料表的 Constraints `business_hour`
--
ALTER TABLE `business_hour`
  ADD CONSTRAINT `business_hour_id_fk` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`id`);
...
--
-- 資料表的 Constraints `restaurant_owner`
--
ALTER TABLE `restaurant_owner`
