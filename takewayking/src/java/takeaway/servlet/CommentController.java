...
public class CommentController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("http://localhost:8080/takewayking/restaurantDetail?rid=" + rid + "&&name=" + name);
    }
    ...
    public ArrayList<Comment> getComment(HttpServletRequest request, HttpServletResponse response) {
        String rid = request.getParameter("rid");
        return commentDb.queryCommentByRestauratId(rid);
    }
    ...
    public void addComment(HttpServletRequest request, HttpServletResponse response) {
        ...
        commentDb.addComment(email, rid, comment);
    }
