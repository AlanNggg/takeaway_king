...
public class SearchTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        try {
            ...
            out.print("<div style=\"float: right; width: 55%;\">\n"
                    + "                    <div class=\"select-wrapper\" style=\"margin: 0px 0px 0px 20px; float: left; \">\n"
                    + "                        <select name=\"category\" id=\"category\" style=\" width: inherit; border-radius: 4px 0px 0px 4px;\">\n"
                    + "                            <option value=\"\">- Search By -</option>\n"
                    + "                            <option value=\"1\">Restaurant Name</option>\n"
                    + "                            <option value=\"1\">Restaurant Address</option>\n"
                    + "                        </select>\n"
                    + "                    </div>\n"
                    + "                    <input type=\"text\" name=\"query\" id=\"query\" value=\"\" placeholder=\"Query\" style=\"width: 500px; float: left; border-radius: 0px;\">\n"
