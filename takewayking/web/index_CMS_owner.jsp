...
<!--            Add Restaurant Page Start-->
      ...
      <div class="w3-third">
        <select class="w3-select" id="areas"  name="areas">
            ...
            <%                        
                        cms = new CMS();
                       ArrayList<String> area = cms.getAllAreas();
                       for(int i = 0 ; i <area.size() ; i++){
            %>

            <option value="<%=area.get(i)%>"><%=area.get(i)%></option>  
            <%           }
            %>
      </select>
    ...
    <div class="w3-third">
       <select name="district" class="w3-select" id="districts" name='districts'>  
          <option value="" disabled selected>-Districts-</option>
          <%                        
                        cms = new CMS();
                       ArrayList<String> district = cms.getAllDist();
                       for(int i = 0 ; i <area.size() ; i++){
            %>

            <option value="<%=district.get(i)%>"><%=district.get(i)%></option>  
            <%           }
            %>
         </select>
    </div>
    <div class="w3-third">
        <select name="subdistrict" class="w3-select" id="subdistricts" name='subdistricts'> 
            <option value="" disabled selected>-Subdistricts-</option>
            <%                        
                        cms = new CMS();
                       ArrayList<String> subdistrict = cms.getAllSubDist();
                       for(int i = 0 ; i <subdistrict.size() ; i++){
            %>

            <option value="<%=subdistrict.get(i)%>"><%=subdistrict.get(i)%></option>  
            <%           }
            %>
        </select>
    </div>
      ...
      <input name="address" id="form_rest_location" class="w3-input w3-border " type="text">
      <br>
      
      <label  class="w3-text-teal"><b>Operation Hour</b></label>
      <input name="hour" id="form_rest_location" class="w3-input w3-border " type="text" placeholder="00:00">
      <br>
