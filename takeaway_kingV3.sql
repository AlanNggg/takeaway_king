...
ALTER TABLE `menus`
  ADD PRIMARY KEY (`id`),
  ADD KEY `menus_reid_fk` (`restaurant_id`);

--
-- 資料表索引 `menu_collections`
--
ALTER TABLE `menu_collections`
  ADD PRIMARY KEY (`user_email`,`menu_id`) USING BTREE,
  ADD KEY `menu_collections_menus_fk` (`restaurant_id`),
  ADD KEY `menu_collections_menus_id_fk` (`menu_id`),
  ADD KEY `menu_collections_re_collections_fk` (`user_email`,`restaurant_id`);
...
--
ALTER TABLE `menus`
  ADD CONSTRAINT `menus_reid_fk` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`id`);

--
-- 資料表的 Constraints `menu_collections`
--
ALTER TABLE `menu_collections`
  ADD CONSTRAINT `menu_collections_menus_id_fk` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`id`),
  ADD CONSTRAINT `menu_collections_re_collections_fk` FOREIGN KEY (`user_email`,`restaurant_id`) REFERENCES `restaurant_collections` (`user_email`, `restaurant_id`),
